...
| S-02 | 顧客管理 | 登録・編集・削除・一覧・詳細表示 | 外部DB照合、SNS情報の自動取得 |
...
#### A2: カスタマーサポート = 5名
- **特徴・タイプ** : サポート業務専従、年齢層は営業より少し若め(25~35代)が多い
...
| F-014 | ステータス管理 | 4状態の偏移(新規/対応中/保留/完了) | 営業担当者、カスタマーサポート | Must |
...
| F-025 | 担当者割当・担当変更の機能 | 各顧客の担当者の割当・変更できる | 全アクター | Must |
